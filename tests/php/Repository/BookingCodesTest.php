...
class BookingCodesTest extends CustomPostTypeTest
{
    ...
    public function testBackwardCompatibility() {
        ...
        self::logDatabaseEntries('Initial database state:');
        
        // first insert codes as if generated by old cb version
        self::insertBookingCode($todayDate, $this->timeframeWithEndDate->ID, $this->locationId, $this->itemId, 'right_code');
        
        
        self::logDatabaseEntries('After inserting old codes:');

        BookingCodes::generate( $this->timeframeWithEndDate,self::ADVANCE_GENERATION_DAYS );
        
        self::logDatabaseEntries('After generating new codes:');
...
*/
    ...
    static function logDatabaseEntries($message) {
        global $wpdb;
        $table_name = $wpdb->prefix . BookingCodes::$tablename;
